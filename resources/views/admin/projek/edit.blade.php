...
@section('content')
    <div class="container mt-4">
        ...
        <div class="card shadow-lg p-4">
            <form action="{{ route('admin.projek.update', $projek->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="deskripsi_projek" name="deskripsi_projek" value="{{ $projek->deskripsi_projek }}"
                        required></textarea>
                </div>
